...
class StudentLettersTestPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
...
const StudentLettersTestPageWrapped = withRouter(StudentLettersTestPage);
